...
const PROGRAMS = [{
    key: "frontend", label: "Frontend и дизайн", shortLabel: "Frontend", about: "Курс для 8-11 классов. Занятия по субботам, продолжительность 3 часа. Работаем в формате мини-лекции + практика: сначала короткое объяснение, затем самостоятельная реализация под руководством преподавателя. По итогу — проект интерфейса мессенджера с подключением к бэкенду."
}, {
    ...
    key: "python", label: "Продуктовая разработка", shortLabel: "Продуктовая", about: "Курс для 8-11 классов. Занятия по вторникам, продолжительность 3 часа. Формат: короткая теория + разбор кода + практика. Собираем полноценный веб-проект на FastAPI/React с базой данных, деплоем и AI-инструментами."
},];
