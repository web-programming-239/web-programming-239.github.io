...
const PROGRAMS = [{
    ...
    key: "python", label: "Продуктовая разработка", shortLabel: "Продуктовая", about: "Курс для 9-11 классов. Занятия по вторникам, продолжительность 3 часа. Формат: короткая теория + разбор кода + практика. Собираем полноценный веб-проект на FastAPI/React с базой данных, деплоем и AI-инструментами."
},];
