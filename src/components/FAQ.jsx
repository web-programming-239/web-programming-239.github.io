...
const PROGRAMS = [{
    key: "frontend", label: "Frontend и дизайн", shortLabel: "Frontend", aboutBefore: "Курс для 8-11 классов. Занятия по ", schedule: "субботам", aboutAfter: ", продолжительность 3 часа. Работаем в формате мини-лекции + практика: сначала короткое объяснение, затем самостоятельная реализация под руководством преподавателя. По итогу — проект интерфейса мессенджера с подключением к бэкенду."
}, {
    key: "algorithms", label: "Алгоритмы (5‑6 класс)", shortLabel: "Алгоритмы", aboutBefore: "Курс для 5-6 классов. Занятия по ", schedule: "четвергам и субботам", aboutAfter: " 1.5 часа. Каждое занятие — понятные примеры на Python, затем задачи и мини-проекты-игры. Регулярно закрепляем материал и учимся объяснять решения."
}, {
    key: "python", label: "Продуктовая разработка", shortLabel: "Продуктовая", aboutBefore: "Курс для 8-11 классов. Занятия по ", schedule: "вторникам", aboutAfter: ", продолжительность 3 часа. Формат: короткая теория + разбор кода + практика. Собираем полноценный веб-проект на FastAPI/React с базой данных, деплоем и AI-инструментами."
},];
            ...
            <div className="page-shell flex flex-col items-center gap-10">
                ...
                <div className="flex w-full max-w-[768px] flex-col items-center gap-6 text-center">
                    ...
                    <p className="type-lead font-ibm font-normal opacity-85">
                        {selected.aboutBefore}<strong className="font-bold">{selected.schedule}</strong>{selected.aboutAfter}
                    </p>
                </div>
